    ...
    def parse(self, text: str):
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"❌ Failed to parse sanitized JSON: {e2}\nRaw: {text[:500]}")