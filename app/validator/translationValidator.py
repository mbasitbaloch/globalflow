...
BRAND_TONES = [
    ...
    "professional",
    "casual",
    "American English (US tone, vocabulary & phrasing)",
    "British English (UK tone, idioms & phrasing)",
    "Canadian English / Quebec French tone depending on target language",
    "Spain Spanish (Castilian / Español de España)",
    "Mexican Spanish (Español de México)",
    "Argentinian Spanish (Español Rioplatense)",
    "European French (France French, natural Parisian tone)",
    "German (Germany-localized tone, formal/informal balance)",
    "Italian (Italy-local tone & idioms)",
    "European Portuguese (Portugal tone)",
    "Brazilian Portuguese (Português do Brasil)",
    "Russian (Russia-local tone, vocabulary, voice)",
    "Simplified Chinese (Mainland China tone & phrasing)",
    "Japanese (Japan-local, polite tone)",
    "Korean (South Korea tone, native phrasing)",
    "Turkish (Turkey-local tone)",
    "Dutch (Netherlands-local tone)",
    "Swedish (Sweden-local tone)",
    "Polish (Poland-local tone)",
    "Ukrainian (Ukraine-local tone)",
    "Romanian (Romania-local tone)",
    "Thai (Thailand-local tone & phrasing)",
    "Vietnamese (Vietnam-local Hội thoại tone)",
    "Indonesian (Bahasa Indonesia native tone)",
    "Greek (Greece-local tone & idioms)",
    "Czech (Czechia-local tone)",
    "Urdu (Pakistan-local tone & phrasing)",
    "Saudi Arabic (Gulf / Saudi local tone)",
    "Emirati Arabic (UAE local Arabic tone)",
    "Egyptian Arabic (Masri local conversational tone)",
    "Indian English / Hindi-influenced localization depending on language",
]
